 ...
 */
package sorcer.provider.sqrt.configs
...
/**
 * Configuration for the Sqrt provider
 *
 * @author Dennis Reedy
 */
@Component('sorcer.core.provider.ServiceProvider')
class SqrtProviderConfig {
    /* service provider genetic properties */
    String name = "Sqrt"
    String description = "Sqrt - bean provider"
    ...
    String remoteLoggerName="remote.sorcer.provider.sqrt.Sqrt"
     ...
     * loaded to obtain deployment properties (declared by the SqrtDeploymentConfig class below).
     *
     * @return An array of service implementation classes required to load the service
     */
    Class[] getBeanClasses() {
        return [sorcer.provider.sqrt.impl.SqrtImpl.class]
    }
    ...
    static String interfaceClass = "sorcer.provider.sqrt.Sqrt.class"
